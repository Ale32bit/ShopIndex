...
namespace ShopIndexWebApp.Server.Migrations
{
    ...
    [Migration("20230708101114_ActualCoordinates")]
    partial class ActualCoordinates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShopIndexWebApp.Shared.Shop", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ShopIndexWebApp.Shared.ShopItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ShopIndexWebApp.Shared.ShopItem", b =>
                {
                    b.HasOne("ShopIndexWebApp.Shared.Shop", null)
                        .WithMany("ShopItems")
